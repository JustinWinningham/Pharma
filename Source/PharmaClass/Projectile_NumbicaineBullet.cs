...
namespace Pharma
{
    public class Projectile_NumbicaineBullet : Bullet
    {
        #region Properties
        //
        public ThingDef_NumbicaineBullet Def
        {
            get
            {
                return this.def as ThingDef_NumbicaineBullet;
            }
        }
        ...
        protected override void Impact(Thing hitThing)
        {
            ...
            if (Def != null && hitThing != null && hitThing != null) //Fancy way to declare a variable inside an if statement. - Thanks Erdelf.
            {
                ...
                else //failure!
                {
                    ...
                    MoteMaker.ThrowText(hitThing.PositionHeld.ToVector3(), hitThing.MapHeld, "NumbicaineRifle_FailureMote".Translate(Def.AddHediffChance), 12f);
                }
            }
        }
        #endregion Overrides
